...
function print_plot_timerange_selection($module, $subtable, $timestamp_var, $constraint, $squash, $renormalize, $variable_list, $variables, $timestamp_begin, $timestamp_end, $timestamp_now, $timestamp_timerange, $new_window)
{
	...
	echo '    else' . "\n";
	echo '    {' . "\n";
	echo '      document.getElementById(module + "_variables").value = "' . implode(',', $variable_list ? $variable_list  : array()) . '";' . "\n";
	echo '      document.getElementById(module + "_squash").value = "1";' . "\n";
	echo '      document.getElementById(module + "_renormalize").value = "1";' . "\n";
	echo '    }' . "\n";
	echo '  }' . "\n";
	...
	echo ' <input type="hidden" name="squash" id="' . $module . '_squash" value="' . htmlentities($squash) . '" />';
	echo ' <input type="hidden" name="renormalize" id="' . $module . '_renormalize" value="' . htmlentities($renormalize) . '" />';
	echo ' <input type="hidden" name="variables" id="' . $module . '_variables" value="' . htmlentities($variables) . '" />';
