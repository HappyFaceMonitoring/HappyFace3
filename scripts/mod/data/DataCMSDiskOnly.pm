package mod::data::DataCMSDiskOnly;
...
system("wget --output-document=\"../data/cms_disk_only_original.html\" \"http://adm-dcache.gridka.de:2289/pools/list/PoolManager/cms-disk-only-pools/spaces/\"");

$source_code = "";
open(ORIGINAL, "../data/cms_disk_only_original.html");
while (<ORIGINAL>) {
	chop;
...
open(NEW_OUTPUT,">../data/cms_disk_only.html");
