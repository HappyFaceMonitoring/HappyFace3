...
var pic1 = new Image();
pic1.src = "/static/images/leftarrow.png";
var pic2 = new Image();
pic2.src = "/static/images/rightarrow.png";
...
function movenav(navid) {
	if (document.getElementById(navid).offsetLeft >= -42) {
		...
		document.getElementById(navid + "arrow").src="/static/images/rightarrow.png";
	} else {
		document.getElementById(navid).style.left="8px";
		document.getElementById(navid + "arrow").src="/static/images/leftarrow.png";
	}
};
