	...
	<?php
		...
		printf('<ul>');
                printf('<li>
                        ...
                        <td style="width:40px;"><div class="HappyFNtopdiv"><a href="javascript:movenav(\\\'HappyFNnav_""" + category + """\\\')" onfocus="this.blur()"><img id="HappyFNnav_""" + category + """arrow" alt="" style="width:32px;border:0px;" src="config/images/rightarrow.png" /></a></div></td>
                        </tr>
                        </table>
                        </li>
                ');		
			...
			$nav_symbol = getModNavSymbol($module["status"], $module["mod_type"]);
				...
				<table class="HappyFNnaventry">
				<tr style="border-bottom:1px solid #FFF;">
				<td style="width:200px;"><a href="javascript:goto(\\\'' . $module["module"] . '\\\')" onfocus="this.blur()">'. $module["mod_title"] . '</a></td>
