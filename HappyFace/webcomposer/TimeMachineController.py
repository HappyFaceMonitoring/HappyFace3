...
class TimeMachineController(object):
	...
	self.output = """	
	<div class="TitleBar">
	    <div class="TitleBarElement"><table class="TitleBarElementTable"><tr><td style="color:orange;">HappyFace Project v2a</td></tr></table></div>
	    <div class="TitleBarElement"><table class="TitleBarElementTable"><tr><td><?php printf($time_message); ?></td><td>
	    ...
	    <div class="TitleBarElement"><table class="TitleBarElementTable"><tr><td>
