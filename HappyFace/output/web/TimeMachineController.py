...
class TimeMachineController(HTMLOutput):
	...
	output.append(   ' </div>')
	output.append(   ' <div class="HappyTitleBarElement">')
	output.append( """  <form id="HistoForm1" class="HappyTitleBarForm" action="' . $_SERVER['SCRIPT_NAME'] . '" method="get">""")
	output.append(   '   <table border="0" class="HappyTitleBarElementTable">')
	output.append(   '    <tr>')
	output.append(   '     <td>')
	output.append(   '      <div>')
	output.append( """       <img src="config/images/left_icon.gif" width="22" height="22" alt="backwards" style="border: none; padding-top: 2px; margin: 0px 2px;" onclick="javascript:HappyHistoNav(\\\'back\\\',\\\'' . $timestamp . '\\\')" onfocus="this.blur()">""")
	output.append(   '      </div>')
	output.append(   '     </td>')
	output.append(   '     <td>')
	output.append(   '      <div>')
	output.append( """       <input type="text" id="HistoStep" name="s" size="4" style="text-align:center;" value="' . $histo_step . '" />""")
	...
	output.append(   '     <td>')
	output.append(   '      <div>')
	output.append( """       <img src="config/images/right_icon.gif" width="22" height="22" alt="forwards" style="border: none; padding-top: 2px; margin: 0px 2px;" onclick="javascript:HappyHistoNav(\\\'fwd\\\',\\\'' .$timestamp . '\\\')" onfocus="this.blur()">""")
	output.append(   '      </div>')
	output.append(   '     </td>')
	output.append(   '    </tr>')
	output.append(   '   </table>')
	...
	output.append(   '')
	output.append(   ' <div class="HappyTitleBarElement">')
	output.append( """  <form id="HistoForm2" class="HappyTitleBarForm" action="' . $_SERVER['SCRIPT_NAME'] . '" method="get">""")
	output.append(   '   <table border="0" class="HappyTitleBarElementTable">')
	output.append(   '    <tr>')
	output.append(   '     <td>')
	output.append(   '      <div>')
	...
	output.append(   ' </div>')
	output.append(   ' <div class="HappyTitleBarElement">')
	output.append( """  <form class="HappyTitleBarForm" action="' . $_SERVER['SCRIPT_NAME'] . '" method="get">""")
	output.append(   '   <table border="0" class="HappyTitleBarElementTable">')
	output.append(   '    <tr>')
	output.append(   '     <td>')
	output.append(   '      <div>')
