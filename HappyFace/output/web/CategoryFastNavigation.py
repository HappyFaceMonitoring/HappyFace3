...
class CategoryFastNavigation(HTMLOutput):
	...
	list_item.append( """      <a href="javascript:goto(\\\'' . $module["module"] . '\\\')" onfocus="this.blur()" ondblclick="HappyReloadPage(\\\'""" + category + """\\\', \\\'' . $module["module"] . '\\\')">'. htmlentities($module["mod_title"]) . '</a>""")
	list_item.append(   '     </td>')
	list_item.append(   '     <td style="width:40px;" align="left">')
	list_item.append(   '      <div class="HappyFNnavimg">')
	list_item.append( """       <a href="javascript:goto(\\\'' . $module["module"] . '\\\')" onfocus="this.blur()" ondblclick="HappyReloadPage(\\\'""" + category + """\\\', \\\'' . $module["module"] . '\\\')">' . $nav_symbol . '</a>""")
